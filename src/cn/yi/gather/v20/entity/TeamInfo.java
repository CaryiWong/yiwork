...
public class TeamInfo implements Serializable{
	...
	@Column(name="zname")
	private String zname;//中文团队名
	
	@Column(name="ename")
	private String ename;//英文团队名
	...
	private String contexturl="";// 详情/团队介绍  URL  相对地址
	...
	@Column(name="weburl")
	private String weburl="";//团队自己的网站/网页URL  绝对地址 支持外链
	...
	public TeamInfo(String id, String zname, String ename, String introduction,
