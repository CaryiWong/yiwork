...
<body>
       <div class="row row-flow">
            <div class="col-xs-12 member-list">
                ...
                <form id="mainForm" name="mainForm" action="<%=basePath %>v20/admin/yigather_account/view_log" method="post">
                     ...
                     <c:if test="${page eq null || page.currentCount eq 0}">
                      ...
                      <c:if test="${page.currentCount gt 0 }">
                         ...
                         <tr>
                             ...
                             <td>${account_log.subject}</td>
                             <td>
                                 <c:if test="${account_log.associatedUserId ne null}">
                                     ${account_log.associatedUserNickname}(${account_log.associatedUserId})
                                 </c:if>
                             </td>
                             <td>
                                 <c:if test="${account_log.operatorId ne null}">
                                     ${account_log.operatorName}(${account_log.operatorId})
                                 </c:if>
                             </td>
