...
<body>
 <div class="row row-flow member-apply">
            <form class="form-horizontal col-xs-12" name="mainform" id="mainform" action="<%=basePath %>admin/user/saveapplyvip"
				method="post" onsubmit="return validateform(this);">
                <div class="row">
                    <div class="form-group col-xs-4">
                        <label class="col-xs-3 control-label"><font color="red">会员号</font></label>
                    ...
                    <div class="form-group col-xs-4">
                        <label class="col-xs-3 control-label"><font color="red">邮箱</font></label>
                    ...
                    <div class="form-group col-xs-4">
                        <label   class="col-xs-3 control-label"><font color="red">手机</font></label>
                    ...
                    <div class="form-group col-xs-4">
                        <label   class="col-xs-3 control-label"><font color="red">昵称</font></label>
                        
                        <div class="col-xs-9">
                            <input type="text"  id="nickname" name="nickname"  class="form-control valid-input"
                                   data-valid-rule="required"/>
                        </div>
                    </div>
