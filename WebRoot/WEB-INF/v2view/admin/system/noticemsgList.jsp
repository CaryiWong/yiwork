...
<div class="row row-flow need-list">
            <div class="form-group col-xs-3">
                <a href="<%=webBasePath%>admin/user/createnotice" class="btn btn-primary col-xs-12">新增公告<i class="glyphicon glyphicon-plus"></i></a>
            </div>
            <div class="col-xs-12">
            <form id="mainForm" name="mainForm" action="<%=webBasePath %>admin/user/noticemsglist" method="post">
						...
						<c:if test="${page.totalPage gt 0 }">
									<c:forEach items="${page.result }" var="sysnetwork" varStatus="vs">
										<tr>
											...
											<td>${sysnetwork.content }</td>
											<td>
												<fmt:formatDate value="${sysnetwork.createtime }" pattern="yyyy-MM-dd HH:mm:ss"/>
											</td>
											<!-- <td><a href="">删除</a></td> -->
										</tr>
									</c:forEach>
