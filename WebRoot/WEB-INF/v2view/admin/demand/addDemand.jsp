            ...
            <button  class="btn btn-default btn-back">返回列表</button>
				...
				method="post" onsubmit="return validateform(this);">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                         	<input type="hidden" name="publishuser.id" id="publishuser.id" value="${session_user.id}">
                            <p class="form-control-static"><a class="form-control-static" href="javascript:;">${session_user.nickname}</a></p>
                        </div>
                    </div>
                    <div class="form-group">
