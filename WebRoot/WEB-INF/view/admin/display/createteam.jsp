			...
			<form name="mainform" id="mainform" action="admin/display/saveteam"
				...
				<table align="center" >
					<tr>
						...
						<td colspan="3"><input id="teamname" name="teamname" style="width: 100%;"/></td>
					</tr>
					<tr style="height: 200px;">
						<td>
							<label>头像<font color="red">*</font></label>
							<input type="file" id="imgfile" name="img" onchange="uploadimg();" style="width: 150px;"/>
							<input type="hidden" name="teamminim" id="teamminim">
						</td>
						<td>
							<img alt="team头像" id="teamicon" src="" style="width: 180px;height: 180px;">
						</td>
						<td>
						...
						<td>
							<img alt="team封面" id="teamcover" src="" style="width: 180px;height: 180px;">
						</td>
					</tr>
					<tr>
						<td><label>简介<font color="red">*</font></label></td>
						<td colspan="3">
							<textarea rows="10" cols="100" id="teamtitle" name="teamtitle"></textarea>
						</td>
					</tr>
					<tr align="center">
