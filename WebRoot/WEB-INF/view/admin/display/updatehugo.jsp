...
<body background="<%=basePath%>res/images/index_background.jpg">
	...
	<div id="main">
		...
		<div id="right"
			...
			<form name="mainform" id="mainform" action="admin/display/updatehugo"
				...
				<table align="center" >
					<tr>
						...
						<td><input id="iusernickname" name="iusernickname" value="${indexuser.iusernickname }"/></td>
						<td><label>职业<font color="red">*</font></label></td>
						<td><input id="iuserjobinfo" name="iuserjobinfo" value="${indexuser.iuserjobinfo }"></td>
					</tr>
					<tr style="height: 200px;">
						...
						<td>
							<img alt="hugo头像" id="hugoicon" src="<%=basePath %>download/img?type=1&path=${indexuser.iuserimg }" style="width: 180px;height: 180px;">
						</td>
						<td>
						...
						<td>
							<img alt="hugo封面" id="hugocover" src="<%=basePath %>download/img?type=1&path=${indexuser.iusermaximg }" style="width: 180px;height: 180px;">
						</td>
					</tr>
					<tr>
						<td><label>简介<font color="red">*</font></label></td>
						<td colspan="3">
							<textarea rows="10" cols="100" id="iusersummery" name="iusersummery">${indexuser.iusersummery }</textarea>
						</td>
					</tr>
					<tr align="center">
