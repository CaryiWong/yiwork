            ...
            <form class="form-horizontal col-xs-12" name="mainform" id="mainform" action="<%=basePath %>admin/user/saveVip"
                    ...
                    <div class="form-group col-xs-4">
                        ...
                        <div class="col-xs-9">
                            <input type="text" id="unum" name="unum" class="form-control valid-input"
                                  value="${vip.vipnum}"  data-valid-rule="required"/>
                        </div>
                    </div>
                    <div class="form-group col-xs-4">
                        ...
                        <div class="col-xs-9">
                            <input type="text" class="form-control valid-input"
                                id="name" name="name"  value="${vip.realname}"  data-valid-rule="required"/>
                        </div>
                    </div>
                    <div class="form-group col-xs-4">
                    ...
                    <div class="form-group col-xs-4">
                        ...
                        <div class="col-xs-9">
                            <input id="email" name="email" type="text" class="form-control valid-input"
                                  value="${vip.realname}"  data-valid-rule="required"/>
                        </div>
                    </div>
                    <div class="form-group col-xs-4">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-xs-10">
                            <textarea rows="4"  id="interests" name="interests"  class="form-control valid-input" data-valid-rule="required">${vip.favourite}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-xs-6">
                        ...
                        <div class="col-xs-10">
                            <textarea rows="4" id="understand" name="understand" class="form-control valid-input" data-valid-rule="required">${vip.favourite}</textarea>
                        </div>
                    </div>
                    <div class="form-group col-xs-6">
