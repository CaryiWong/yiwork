...
//    var $customCheckbox = $('.custom-checkbox').not('.disabled').click(function () {
//        var $custom = $(this).toggleClass('active');
//    });

    _$formControl.on('click', '.custom-checkbox:not(.disabled)', function () {
        var $custom = $(this).toggleClass('active');
    });

    // radio

//    var $customRadio = $('.custom-radio').not('.disabled').click(function () {
//        var $this = $(this),
...
//    });
    ...
    _$formControl.on('click', '.custom-radio:not(.disabled)', function () {
        var $this = $(this),
            name = $this.find('input').attr('name');
        $('[name="' + name + '"]').parents('.custom-radio').removeClass('active');
        $this.addClass('active');
    ...
    var switchForm = {
        ...
        action: {
            ...
            addCheckboxToView: function ($customCheckbox, group, text, $chooseView, $originCheckbox) {
                ...
                $customCheckbox.find('input').attr('name', group).attr('data-valid-group', group);
            ...
            switchEdit: function ($this) {
                ...
                $value.each(function () {
                    ...
                    if ($input.length) {
                        var value = $this.attr('data-switch-value') || $this.html();
                        value = $.trim(value);
                        $this.hide();
