		...
		<!-- 
		 ...
		 -->
		   <div class="form-control idtype">
		 	...
		 	<div class="form-control idtype">
                <label class="form-control-label">
                    所属空间<span class="form-control-label-required">＊</span>
                </label>
               <div class="form-control-customSelect">
                        <select id="space_id" class="form-control-select">
                            <option value="yq88888888888888">一起</option>
                            <option value="143979159465468390dc95b">wedo</option>
                        </select>
                         <div class="form-control-customSelect-value">
                         </div>
                         <div class="form-control-customSelect-button">
            ...
            <div class="form-control-group">
                <div class="form-control email fl">
                    ...
                    <div class="form-control-input">
                        <input id="menberEmail" class="form-control-text text valid-input" type="email"
...
<div class="apply-dialog hide">
    ...
    <p class="apply-dialog-text">你的登录密码：<font style="color: red;padding: 25px 0 0 60px" id="loginTel">请下载APP后设置密码</font>
