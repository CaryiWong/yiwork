...
<div class="container">
    ...
    <div class="form-control form-control-advance activityType location">
                        <label class="form-control-label form-control-select-label">
                            所在地
                        </label>
                    ...
                    <div class="form-control company fl">
                        <label class="form-control-label">
                            公司/组织
                        </label>

                        <div class="form-control-input">
                            <input class="form-control-text text" name="company" type="text"/>
                        </div>
                    </div>
            </div>
